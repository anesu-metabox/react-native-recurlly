...
const projectToken = (extra?.posthogProjectToken || process.env.EXPO_PUBLIC_POSTHOG_PROJECT_TOKEN)?.trim();
const host = (extra?.posthogHost || process.env.EXPO_PUBLIC_POSTHOG_HOST)?.trim();
